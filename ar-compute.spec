...
install --directory %{buildroot}/usr/lib/ar-compute
...
install --mode 644 status-computation/java/MyUDF.jar %{buildroot}/usr/lib/ar-compute
...
%attr(0755,root,root) /usr/lib/ar-compute/MyUDF.jar
