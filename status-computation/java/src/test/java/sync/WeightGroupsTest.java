...
public class WeightGroupsTest {
	...
	public static void setUpBeforeClass() throws Exception {
		...
		assertNotNull("Test file missing", WeightGroupsTest.class.getResource("/avro/weights_v2.avro"));
	}

	@Test
	public void test() throws IOException, URISyntaxException {
		// Prepare Resource File
		URL resAvroFile = WeightGroupsTest.class.getResource("/avro/weights_v2.avro");
