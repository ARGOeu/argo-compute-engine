...
public class GroupEndpointTimelines extends EvalFunc<Tuple> {
    ...
    public GroupEndpointTimelines(String fnOps, String fnAps, String fnRec, String fnGG, String fnCfg,
            String targetDate, String fsUsed, String sPeriod, String sInterval) {
